...
Nutzerdaten werden in der Regel automatisch durch Methoden wie `initializeParams()` maskiert. Näheres dazu erfahren Sie in [:export_de/Kategorie:POST/GET-Parameter lesen und Sessiondaten verwalten](/:export_de/Kategorie:POST/GET-Parameter_lesen_und_Sessiondaten_verwalten ).
