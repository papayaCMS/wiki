...
As usual, you need to create a GUID and add it to the *guid* attribute as a value (see section [Preparing the modules.xml file](/Module_Development_1:_Content_Modules#Preparing_the_modules.xml_file "wikilink") in the first part of this tutorial series for details).
