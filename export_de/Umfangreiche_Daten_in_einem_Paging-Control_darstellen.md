...
Das folgende Beispiel stellt vor, wie Sie eine Liste mit einem Paging-Control erweitern können. Dazu wird für die in [:Kategorie:Eigene Anwendungen schreiben](/:export_de/Kategorie:Eigene_Anwendungen_schreiben ) erstellte Liste von Stickern ein Paging-Control implementiert. Dadurch werden immer nur eine bestimmte Anzahl Sticker je Seite angezeigt.
...
[Kategorie:Widgets für die Benutzeroberfläche einsetzen](export_de/Kategorie:Widgets_für_die_Benutzeroberfläche_einsetzen )