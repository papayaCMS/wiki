...
1.  Mit dem Rewriting von URLs lassen sich suchmaschinenfreundliche Links erzeugen, da bestimmte Informationen wie die Seiten-ID, die Sprachversion oder die ID der export_de/Kategorie.md nicht über URL-Parameter an die `index.html` übergeben werden.
